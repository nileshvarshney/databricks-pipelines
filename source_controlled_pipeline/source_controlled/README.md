...
The 'source_controlled' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/source_controlled_etl`: Pipeline code and assets for the source_controlled_etl pipeline.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] source_controlled_etl` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/source_controlled_etl/source_controlled_job.job.yml). The schedule
